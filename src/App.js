      ...
      <div className="max-w-6xl mx-auto px-4 py-4 md:py-8 w-[95%] bg-zinc-200">
        <header className="grid">
          <div className="w-full flex justify-center">
            <img src="vh.png" className="mb-6 rounded-xl w-[100%]"></img>
          </div>
          <div className="flex items-center gap-4 mb-6">
            <div className="w-48 md:size-40 relative overflow-hidden rounded-full">
              <img src="v.png" alt="User" className="w-full h-full" />
            </div>
            <div className="md:space-y-0 md:-mt-1">
              <div className="flex space-x-3">
                <h1 className="text-xl font-extrabold md:text-5xl">vDOG</h1>
                <div className='flex justify-center items-center z-10'>
                  <a href="https://x.com/vDOGtoken" className=''>
                  ...
                  <a href="https://t.me/vDOGPortal" className=''>
              ...
              <p className="text-sm md:text-base text-gray-600">@vDOG • 420K subscribers</p>
              <p className="text-xs md:text-base text-gray-600">28 years old. Entreprenuer. Sharing my journey.</p>
              <p className="text-xs md:text-base text-gray-600 pb-1">CA: BMM74zQ5JSnHWCnG5i2WUjMknm4szq8KMP1NPVLQpump</p>
              <button 
